...
#    Updated: 2021/10/13 14:18:45 by mmasuda          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
S_SRCS := srcs/server.c srcs/server_utils.c srcs/utils.c

C_BONUS_SRCS := srcs_bonus/client_bonus.c srcs_bonus/utils_bonus.c
S_BONUS_SRCS := srcs_bonus/server_bonus.c srcs_bonus/server_utils_bonus.c srcs_bonus/utils_bonus.c
